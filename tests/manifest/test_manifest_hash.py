...
class TestManifestHash:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            lambda p: setattr(p, "feature_dp_epsilon", 0.5),
            lambda p: setattr(p, "feature_noise_mechanism", "laplace"),
            ...
            lambda p: setattr(p, "gradient_dp_epsilon", 0.7),
            lambda p: setattr(p, "min_classes_to_reveal", 3),
            lambda p: setattr(p, "label_key_hash_length", 8),
